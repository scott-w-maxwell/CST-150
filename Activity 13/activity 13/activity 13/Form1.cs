namespace activity_13
{
    public partial class Form1 : Form
    {
        ...
        // Used in each case a turn takes place
        public void handlePress(Button button, int index1, int index2)
        {
            // If game is in progress and place on board is empty
    ...
    // Holds data for tic-tac-toe game
    class Game
    {
        ...
        {
            // There can't be a winner if each player only has 2 moves
            if (this.turnCount <= 4)
            {
                return "No Winner";
            }
